...
const GenericContainerComponent = ({ heading, subheading, children }) => {
  return (
    <div className="bg-richblack-900 w-11/12 lg:h-[calc(100vh-3.5rem)] h-[calc(100vh - 82px)] grid place-content-center lg:mt-0 mt-10" >
      <div className="lg:max-w-[33rem] w-full lg:p-8 ">
